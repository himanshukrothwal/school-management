...
firstw=Tk()
firstw.title("Himanshu School of learning")
firstw.geometry("1600x1000+0+0")
label=Label(text="Himanshu School of learning",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("Himanshu School of learning")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="Himanshu School of learning", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def root():
    ...
    root.title("Himanshu School of learning")
    global entry1
    global entry2
    global entry3
    global entry4
